...
class AWSSSMPatchBaseline(logicalId: String) : Resource<AWSSSMPatchBaseline.Properties>(logicalId, "AWS::SSM::PatchBaseline") {
    ...
    class Properties : ResourceProperties {
        ...
        fun approvalRules(value: RuleGroup?) { this.approvalRules = value }
        fun approvalRules(value: IntrinsicFunction) { this.approvalRules = value }
        @JvmField var approvedPatches: Any? = null
        fun approvedPatches(value: List<String>?) { this.approvedPatches = value }
        ...
        fun approvedPatchesComplianceLevel(value: String?) { this.approvedPatchesComplianceLevel = value }
        ...
        fun globalFilters(value: PatchFilterGroup?) { this.globalFilters = value }
