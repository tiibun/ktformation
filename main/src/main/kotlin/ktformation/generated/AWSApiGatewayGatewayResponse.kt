...
class AWSApiGatewayGatewayResponse(logicalId: String) : Resource<AWSApiGatewayGatewayResponse.Properties>(logicalId, "AWS::ApiGateway::GatewayResponse") {
    ...
    class Properties : ResourceProperties {
        ...
        fun responseParameters(value: Map<String, String>?) { this.responseParameters = value }
        fun responseParameters(value: IntrinsicFunction) { this.responseParameters = value }
        @JvmField var responseTemplates: Any? = null
        fun responseTemplates(value: Map<String, String>?) { this.responseTemplates = value }
        fun responseTemplates(value: IntrinsicFunction) { this.responseTemplates = value }
        ...
        fun statusCode(value: String?) { this.statusCode = value }
