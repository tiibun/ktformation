...
class AWSDMSEndpoint(logicalId: String) : Resource<AWSDMSEndpoint.Properties>(logicalId, "AWS::DMS::Endpoint") {
    ...
    class Properties : ResourceProperties {
        ...
        fun dynamoDbSettings(value: DynamoDbSettings?) { this.dynamoDbSettings = value }
        fun dynamoDbSettings(value: IntrinsicFunction) { this.dynamoDbSettings = value }
        @JvmField var endpointIdentifier: Any? = null
        fun endpointIdentifier(value: String?) { this.endpointIdentifier = value }
        ...
        fun extraConnectionAttributes(value: String?) { this.extraConnectionAttributes = value }
        ...
        fun mongoDbSettings(value: MongoDbSettings?) { this.mongoDbSettings = value }
