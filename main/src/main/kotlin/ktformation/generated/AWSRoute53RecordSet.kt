...
class AWSRoute53RecordSet(logicalId: String) : Resource<AWSRoute53RecordSet.Properties>(logicalId, "AWS::Route53::RecordSet") {
    ...
    class Properties : ResourceProperties {
        ...
        fun weight(value: Int?) { this.weight = value }
