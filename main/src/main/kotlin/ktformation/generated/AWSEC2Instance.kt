...
class AWSEC2Instance(logicalId: String) : Resource<AWSEC2Instance.Properties>(logicalId, "AWS::EC2::Instance") {
    ...
    class Properties : ResourceProperties {
        ...
        fun additionalInfo(value: String?) { this.additionalInfo = value }
        fun additionalInfo(value: IntrinsicFunction) { this.additionalInfo = value }
        @JvmField var affinity: Any? = null
        fun affinity(value: String?) { this.affinity = value }
        ...
        fun blockDeviceMappings(value: List<BlockDeviceMapping>?) { this.blockDeviceMappings = value }
        ...
        fun hostId(value: String?) { this.hostId = value }
        fun hostId(value: IntrinsicFunction) { this.hostId = value }
        @JvmField var iamInstanceProfile: Any? = null
        fun iamInstanceProfile(value: String?) { this.iamInstanceProfile = value }
        ...
        fun instanceInitiatedShutdownBehavior(value: String?) { this.instanceInitiatedShutdownBehavior = value }
        ...
        fun placementGroupName(value: String?) { this.placementGroupName = value }
        ...
        fun ramdiskId(value: String?) { this.ramdiskId = value }
        ...
        fun ssmAssociations(value: List<SsmAssociation>?) { this.ssmAssociations = value }
        ...
        fun tenancy(value: String?) { this.tenancy = value }
        fun tenancy(value: IntrinsicFunction) { this.tenancy = value }
        @JvmField var userData: Any? = null
        fun userData(value: String?) { this.userData = value }
