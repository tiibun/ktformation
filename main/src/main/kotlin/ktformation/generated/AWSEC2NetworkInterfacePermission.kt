...
class AWSEC2NetworkInterfacePermission(logicalId: String) : Resource<AWSEC2NetworkInterfacePermission.Properties>(logicalId, "AWS::EC2::NetworkInterfacePermission") {
    ...
    class Properties : ResourceProperties {
        @JvmField var awsAccountId: Any? = null
        fun awsAccountId(value: String) { this.awsAccountId = value }
        fun awsAccountId(value: IntrinsicFunction) { this.awsAccountId = value }
        ...
        @JvmField var permission: Any? = null
        fun permission(value: String) { this.permission = value }
        fun permission(value: IntrinsicFunction) { this.permission = value }
    }
