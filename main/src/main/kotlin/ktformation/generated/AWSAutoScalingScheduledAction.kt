...
class AWSAutoScalingScheduledAction(logicalId: String) : Resource<AWSAutoScalingScheduledAction.Properties>(logicalId, "AWS::AutoScaling::ScheduledAction") {
    ...
    class Properties : ResourceProperties {
        ...
        fun desiredCapacity(value: Int?) { this.desiredCapacity = value }
        fun desiredCapacity(value: IntrinsicFunction) { this.desiredCapacity = value }
        @JvmField var endTime: Any? = null
        fun endTime(value: String?) { this.endTime = value }
        fun endTime(value: IntrinsicFunction) { this.endTime = value }
        ...
        @JvmField var recurrence: Any? = null
        fun recurrence(value: String?) { this.recurrence = value }
        fun recurrence(value: IntrinsicFunction) { this.recurrence = value }
        @JvmField var startTime: Any? = null
        fun startTime(value: String?) { this.startTime = value }
        fun startTime(value: IntrinsicFunction) { this.startTime = value }
    }
