...
class AWSIAMManagedPolicy(logicalId: String) : Resource<AWSIAMManagedPolicy.Properties>(logicalId, "AWS::IAM::ManagedPolicy") {
    ...
    class Properties : ResourceProperties {
        ...
        @JvmField var managedPolicyName: Any? = null
        fun managedPolicyName(value: String?) { this.managedPolicyName = value }
        fun managedPolicyName(value: IntrinsicFunction) { this.managedPolicyName = value }
