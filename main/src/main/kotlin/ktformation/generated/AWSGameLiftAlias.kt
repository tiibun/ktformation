...
class AWSGameLiftAlias(logicalId: String) : Resource<AWSGameLiftAlias.Properties>(logicalId, "AWS::GameLift::Alias") {
    ...
    class Properties : ResourceProperties {
        ...
        @JvmField var routingStrategy: Any? = null
        fun routingStrategy(value: RoutingStrategy) { this.routingStrategy = value }
        fun routingStrategy(value: IntrinsicFunction) { this.routingStrategy = value }
    }
