...
class AWSEC2SecurityGroupIngress(logicalId: String) : Resource<AWSEC2SecurityGroupIngress.Properties>(logicalId, "AWS::EC2::SecurityGroupIngress") {
    ...
    class Properties : ResourceProperties {
        ...
        fun cidrIpv6(value: String?) { this.cidrIpv6 = value }
        ...
        fun fromPort(value: Int?) { this.fromPort = value }
        ...
        fun sourceSecurityGroupId(value: String?) { this.sourceSecurityGroupId = value }
        ...
        fun sourceSecurityGroupName(value: String?) { this.sourceSecurityGroupName = value }
