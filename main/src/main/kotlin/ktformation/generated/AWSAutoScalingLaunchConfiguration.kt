...
class AWSAutoScalingLaunchConfiguration(logicalId: String) : Resource<AWSAutoScalingLaunchConfiguration.Properties>(logicalId, "AWS::AutoScaling::LaunchConfiguration") {
    ...
    class Properties : ResourceProperties {
        ...
        fun associatePublicIpAddress(value: Boolean?) { this.associatePublicIpAddress = value }
        ...
        fun classicLinkVPCId(value: String?) { this.classicLinkVPCId = value }
        ...
        fun classicLinkVPCSecurityGroups(value: List<String>?) { this.classicLinkVPCSecurityGroups = value }
        ...
        fun instanceMonitoring(value: Boolean?) { this.instanceMonitoring = value }
        ...
        fun placementTenancy(value: String?) { this.placementTenancy = value }
        ...
        fun spotPrice(value: String?) { this.spotPrice = value }
