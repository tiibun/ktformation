...
class AWSDynamoDBTable(logicalId: String) : Resource<AWSDynamoDBTable.Properties>(logicalId, "AWS::DynamoDB::Table") {
    ...
    class Properties : ResourceProperties {
        ...
        fun attributeDefinitions(value: List<AttributeDefinition>?) { this.attributeDefinitions = value }
        ...
        fun globalSecondaryIndexes(value: List<GlobalSecondaryIndex>?) { this.globalSecondaryIndexes = value }
        ...
        fun localSecondaryIndexes(value: List<LocalSecondaryIndex>?) { this.localSecondaryIndexes = value }
        ...
        fun streamSpecification(value: StreamSpecification?) { this.streamSpecification = value }
        fun streamSpecification(value: IntrinsicFunction) { this.streamSpecification = value }
        @JvmField var tableName: Any? = null
        fun tableName(value: String?) { this.tableName = value }
        ...
        fun timeToLiveSpecification(value: TimeToLiveSpecification?) { this.timeToLiveSpecification = value }
