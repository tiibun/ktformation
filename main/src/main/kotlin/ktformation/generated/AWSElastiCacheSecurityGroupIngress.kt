...
class AWSElastiCacheSecurityGroupIngress(logicalId: String) : Resource<AWSElastiCacheSecurityGroupIngress.Properties>(logicalId, "AWS::ElastiCache::SecurityGroupIngress") {
    ...
    class Properties : ResourceProperties {
        @JvmField var cacheSecurityGroupName: Any? = null
        fun cacheSecurityGroupName(value: String) { this.cacheSecurityGroupName = value }
        fun cacheSecurityGroupName(value: IntrinsicFunction) { this.cacheSecurityGroupName = value }
