...
class AWSApiGatewayApiKey(logicalId: String) : Resource<AWSApiGatewayApiKey.Properties>(logicalId, "AWS::ApiGateway::ApiKey") {
    ...
    class Properties : ResourceProperties {
        @JvmField var customerId: Any? = null
        fun customerId(value: String?) { this.customerId = value }
        fun customerId(value: IntrinsicFunction) { this.customerId = value }
        ...
        @JvmField var generateDistinctId: Any? = null
        fun generateDistinctId(value: Boolean?) { this.generateDistinctId = value }
        fun generateDistinctId(value: IntrinsicFunction) { this.generateDistinctId = value }
        @JvmField var name: Any? = null
        fun name(value: String?) { this.name = value }
        fun name(value: IntrinsicFunction) { this.name = value }
        @JvmField var stageKeys: Any? = null
        fun stageKeys(value: List<StageKey>?) { this.stageKeys = value }
        fun stageKeys(vararg value: IntrinsicFunction) { this.stageKeys = value }
    }
