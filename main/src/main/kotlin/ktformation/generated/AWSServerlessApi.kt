...
class AWSServerlessApi(logicalId: String) : Resource<AWSServerlessApi.Properties>(logicalId, "AWS::Serverless::Api") {
    ...
    class Properties : ResourceProperties {
        ...
        fun cacheClusterEnabled(value: Boolean?) { this.cacheClusterEnabled = value }
        fun cacheClusterEnabled(value: IntrinsicFunction) { this.cacheClusterEnabled = value }
        @JvmField var cacheClusterSize: Any? = null
        fun cacheClusterSize(value: String?) { this.cacheClusterSize = value }
        fun cacheClusterSize(value: IntrinsicFunction) { this.cacheClusterSize = value }
        @JvmField var definitionBody: Any? = null
        fun definitionBody(value: Json?) { this.definitionBody = value }
        fun definitionBody(value: IntrinsicFunction) { this.definitionBody = value }
        @JvmField var definitionUri: Any? = null
        fun definitionUri(value: S3LocationOrString?) { this.definitionUri = value }
        fun definitionUri(value: IntrinsicFunction) { this.definitionUri = value }
        ...
        fun variables(value: Map<String, String>?) { this.variables = value }
        fun variables(value: IntrinsicFunction) { this.variables = value }
    }
