...
class AWSApplicationAutoScalingScalableTarget(logicalId: String) : Resource<AWSApplicationAutoScalingScalableTarget.Properties>(logicalId, "AWS::ApplicationAutoScaling::ScalableTarget") {
    ...
    class Properties : ResourceProperties {
        @JvmField var maxCapacity: Any? = null
        fun maxCapacity(value: Int) { this.maxCapacity = value }
        fun maxCapacity(value: IntrinsicFunction) { this.maxCapacity = value }
        @JvmField var minCapacity: Any? = null
        fun minCapacity(value: Int) { this.minCapacity = value }
        fun minCapacity(value: IntrinsicFunction) { this.minCapacity = value }
