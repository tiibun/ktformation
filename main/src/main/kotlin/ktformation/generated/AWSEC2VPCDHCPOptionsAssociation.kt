...
class AWSEC2VPCDHCPOptionsAssociation(logicalId: String) : Resource<AWSEC2VPCDHCPOptionsAssociation.Properties>(logicalId, "AWS::EC2::VPCDHCPOptionsAssociation") {
    ...
    class Properties : ResourceProperties {
        @JvmField var dhcpOptionsId: Any? = null
        fun dhcpOptionsId(value: String) { this.dhcpOptionsId = value }
        fun dhcpOptionsId(value: IntrinsicFunction) { this.dhcpOptionsId = value }
