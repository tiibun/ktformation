...
class AWSElasticBeanstalkConfigurationTemplate(logicalId: String) : Resource<AWSElasticBeanstalkConfigurationTemplate.Properties>(logicalId, "AWS::ElasticBeanstalk::ConfigurationTemplate") {
    ...
    class Properties : ResourceProperties {
        ...
        @JvmField var environmentId: Any? = null
        fun environmentId(value: String?) { this.environmentId = value }
        fun environmentId(value: IntrinsicFunction) { this.environmentId = value }
        @JvmField var optionSettings: Any? = null
        fun optionSettings(value: List<ConfigurationOptionSetting>?) { this.optionSettings = value }
        ...
        @JvmField var sourceConfiguration: Any? = null
        fun sourceConfiguration(value: SourceConfiguration?) { this.sourceConfiguration = value }
        fun sourceConfiguration(value: IntrinsicFunction) { this.sourceConfiguration = value }
    }
