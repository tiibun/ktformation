...
class AWSGlueCrawler(logicalId: String) : Resource<AWSGlueCrawler.Properties>(logicalId, "AWS::Glue::Crawler") {
    ...
    class Properties : ResourceProperties {
        @JvmField var classifiers: Any? = null
        fun classifiers(value: List<String>?) { this.classifiers = value }
        fun classifiers(vararg value: IntrinsicFunction) { this.classifiers = value }
        ...
        fun schedule(value: Schedule?) { this.schedule = value }
        fun schedule(value: IntrinsicFunction) { this.schedule = value }
        @JvmField var schemaChangePolicy: Any? = null
        fun schemaChangePolicy(value: SchemaChangePolicy?) { this.schemaChangePolicy = value }
        fun schemaChangePolicy(value: IntrinsicFunction) { this.schemaChangePolicy = value }
        @JvmField var tablePrefix: Any? = null
        fun tablePrefix(value: String?) { this.tablePrefix = value }
        fun tablePrefix(value: IntrinsicFunction) { this.tablePrefix = value }
        @JvmField var targets: Any? = null
        fun targets(value: Targets) { this.targets = value }
        fun targets(value: IntrinsicFunction) { this.targets = value }
    }
