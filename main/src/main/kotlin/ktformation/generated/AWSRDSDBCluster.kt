...
class AWSRDSDBCluster(logicalId: String) : Resource<AWSRDSDBCluster.Properties>(logicalId, "AWS::RDS::DBCluster") {
    ...
    class Properties : ResourceProperties {
        ...
        fun backupRetentionPeriod(value: Int?) { this.backupRetentionPeriod = value }
        ...
        fun dBClusterParameterGroupName(value: String?) { this.dBClusterParameterGroupName = value }
        ...
        fun replicationSourceIdentifier(value: String?) { this.replicationSourceIdentifier = value }
