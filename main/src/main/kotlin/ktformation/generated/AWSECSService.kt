...
class AWSECSService(logicalId: String) : Resource<AWSECSService.Properties>(logicalId, "AWS::ECS::Service") {
    ...
    class Properties : ResourceProperties {
        ...
        fun placementConstraints(value: List<PlacementConstraint>?) { this.placementConstraints = value }
        ...
        fun placementStrategies(value: List<PlacementStrategy>?) { this.placementStrategies = value }
        ...
        fun platformVersion(value: String?) { this.platformVersion = value }
