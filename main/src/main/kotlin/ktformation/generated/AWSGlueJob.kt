...
class AWSGlueJob(logicalId: String) : Resource<AWSGlueJob.Properties>(logicalId, "AWS::Glue::Job") {
    ...
    class Properties : ResourceProperties {
        ...
        fun allocatedCapacity(value: Double?) { this.allocatedCapacity = value }
        ...
        fun connections(value: ConnectionsList?) { this.connections = value }
        fun connections(value: IntrinsicFunction) { this.connections = value }
        @JvmField var defaultArguments: Any? = null
        fun defaultArguments(value: Json?) { this.defaultArguments = value }
        ...
        fun executionProperty(value: ExecutionProperty?) { this.executionProperty = value }
        ...
        fun maxRetries(value: Double?) { this.maxRetries = value }
