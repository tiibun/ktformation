...
class AWSRedshiftClusterSecurityGroupIngress(logicalId: String) : Resource<AWSRedshiftClusterSecurityGroupIngress.Properties>(logicalId, "AWS::Redshift::ClusterSecurityGroupIngress") {
    ...
    class Properties : ResourceProperties {
        ...
        @JvmField var clusterSecurityGroupName: Any? = null
        fun clusterSecurityGroupName(value: String) { this.clusterSecurityGroupName = value }
        fun clusterSecurityGroupName(value: IntrinsicFunction) { this.clusterSecurityGroupName = value }
