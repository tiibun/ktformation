...
class AWSDMSReplicationTask(logicalId: String) : Resource<AWSDMSReplicationTask.Properties>(logicalId, "AWS::DMS::ReplicationTask") {
    ...
    class Properties : ResourceProperties {
        ...
        fun migrationType(value: IntrinsicFunction) { this.migrationType = value }
        @JvmField var replicationInstanceArn: Any? = null
        ...
        fun sourceEndpointArn(value: IntrinsicFunction) { this.sourceEndpointArn = value }
        @JvmField var tableMappings: Any? = null
        ...
        fun targetEndpointArn(value: IntrinsicFunction) { this.targetEndpointArn = value }
    }
