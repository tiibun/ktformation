...
class AWSDMSReplicationInstance(logicalId: String) : Resource<AWSDMSReplicationInstance.Properties>(logicalId, "AWS::DMS::ReplicationInstance") {
    ...
    class Properties : ResourceProperties {
        ...
        fun allocatedStorage(value: Int?) { this.allocatedStorage = value }
        ...
        fun replicationInstanceIdentifier(value: String?) { this.replicationInstanceIdentifier = value }
        ...
        fun replicationSubnetGroupIdentifier(value: String?) { this.replicationSubnetGroupIdentifier = value }
