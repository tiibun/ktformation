...
class AWSApiGatewayRestApi(logicalId: String) : Resource<AWSApiGatewayRestApi.Properties>(logicalId, "AWS::ApiGateway::RestApi") {
    ...
    class Properties : ResourceProperties {
        @JvmField var binaryMediaTypes: Any? = null
        fun binaryMediaTypes(value: List<String>?) { this.binaryMediaTypes = value }
        fun binaryMediaTypes(vararg value: IntrinsicFunction) { this.binaryMediaTypes = value }
        @JvmField var body: Any? = null
        fun body(value: Json?) { this.body = value }
        fun body(value: IntrinsicFunction) { this.body = value }
        @JvmField var bodyS3Location: Any? = null
        fun bodyS3Location(value: S3Location?) { this.bodyS3Location = value }
        fun bodyS3Location(value: IntrinsicFunction) { this.bodyS3Location = value }
        @JvmField var cloneFrom: Any? = null
        fun cloneFrom(value: String?) { this.cloneFrom = value }
        fun cloneFrom(value: IntrinsicFunction) { this.cloneFrom = value }
        ...
        @JvmField var failOnWarnings: Any? = null
        fun failOnWarnings(value: Boolean?) { this.failOnWarnings = value }
        fun failOnWarnings(value: IntrinsicFunction) { this.failOnWarnings = value }
        @JvmField var mode: Any? = null
        fun mode(value: String?) { this.mode = value }
        fun mode(value: IntrinsicFunction) { this.mode = value }
