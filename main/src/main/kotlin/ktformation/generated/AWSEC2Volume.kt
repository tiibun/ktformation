...
class AWSEC2Volume(logicalId: String) : Resource<AWSEC2Volume.Properties>(logicalId, "AWS::EC2::Volume") {
    ...
    class Properties : ResourceProperties {
        ...
        fun autoEnableIO(value: Boolean?) { this.autoEnableIO = value }
        ...
        fun size(value: Int?) { this.size = value }
        fun size(value: IntrinsicFunction) { this.size = value }
        @JvmField var snapshotId: Any? = null
        fun snapshotId(value: String?) { this.snapshotId = value }
        ...
        fun volumeType(value: String?) { this.volumeType = value }
