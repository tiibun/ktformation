...
class AWSEC2VPC(logicalId: String) : Resource<AWSEC2VPC.Properties>(logicalId, "AWS::EC2::VPC") {
    ...
    class Properties : ResourceProperties {
        ...
        @JvmField var enableDnsHostnames: Any? = null
        fun enableDnsHostnames(value: Boolean?) { this.enableDnsHostnames = value }
        fun enableDnsHostnames(value: IntrinsicFunction) { this.enableDnsHostnames = value }
        @JvmField var enableDnsSupport: Any? = null
        fun enableDnsSupport(value: Boolean?) { this.enableDnsSupport = value }
        fun enableDnsSupport(value: IntrinsicFunction) { this.enableDnsSupport = value }
        @JvmField var instanceTenancy: Any? = null
        fun instanceTenancy(value: String?) { this.instanceTenancy = value }
        fun instanceTenancy(value: IntrinsicFunction) { this.instanceTenancy = value }
