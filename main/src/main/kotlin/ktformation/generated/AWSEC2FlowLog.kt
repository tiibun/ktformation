...
class AWSEC2FlowLog(logicalId: String) : Resource<AWSEC2FlowLog.Properties>(logicalId, "AWS::EC2::FlowLog") {
    ...
    class Properties : ResourceProperties {
        @JvmField var deliverLogsPermissionArn: Any? = null
        fun deliverLogsPermissionArn(value: String) { this.deliverLogsPermissionArn = value }
        fun deliverLogsPermissionArn(value: IntrinsicFunction) { this.deliverLogsPermissionArn = value }
        ...
        @JvmField var resourceType: Any? = null
        fun resourceType(value: String) { this.resourceType = value }
        fun resourceType(value: IntrinsicFunction) { this.resourceType = value }
        @JvmField var trafficType: Any? = null
        fun trafficType(value: String) { this.trafficType = value }
        fun trafficType(value: IntrinsicFunction) { this.trafficType = value }
    }
