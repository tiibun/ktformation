...
class AWSEC2SecurityGroupEgress(logicalId: String) : Resource<AWSEC2SecurityGroupEgress.Properties>(logicalId, "AWS::EC2::SecurityGroupEgress") {
    ...
    class Properties : ResourceProperties {
        ...
        fun destinationPrefixListId(value: String?) { this.destinationPrefixListId = value }
        ...
        fun destinationSecurityGroupId(value: String?) { this.destinationSecurityGroupId = value }
