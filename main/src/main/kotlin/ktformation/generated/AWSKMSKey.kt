...
class AWSKMSKey(logicalId: String) : Resource<AWSKMSKey.Properties>(logicalId, "AWS::KMS::Key") {
    ...
    class Properties : ResourceProperties {
        ...
        @JvmField var enableKeyRotation: Any? = null
        fun enableKeyRotation(value: Boolean?) { this.enableKeyRotation = value }
        fun enableKeyRotation(value: IntrinsicFunction) { this.enableKeyRotation = value }
        ...
        @JvmField var keyPolicy: Any? = null
        fun keyPolicy(value: Json) { this.keyPolicy = value }
        fun keyPolicy(value: IntrinsicFunction) { this.keyPolicy = value }
        @JvmField var keyUsage: Any? = null
        fun keyUsage(value: String?) { this.keyUsage = value }
        fun keyUsage(value: IntrinsicFunction) { this.keyUsage = value }
