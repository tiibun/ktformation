...
class AWSCloud9EnvironmentEC2(logicalId: String) : Resource<AWSCloud9EnvironmentEC2.Properties>(logicalId, "AWS::Cloud9::EnvironmentEC2") {
    ...
    class Properties : ResourceProperties {
        @JvmField var automaticStopTimeMinutes: Any? = null
        fun automaticStopTimeMinutes(value: Int?) { this.automaticStopTimeMinutes = value }
        fun automaticStopTimeMinutes(value: IntrinsicFunction) { this.automaticStopTimeMinutes = value }
        ...
        @JvmField var ownerArn: Any? = null
        fun ownerArn(value: String?) { this.ownerArn = value }
        fun ownerArn(value: IntrinsicFunction) { this.ownerArn = value }
        @JvmField var repositories: Any? = null
        fun repositories(value: List<Repository>?) { this.repositories = value }
        fun repositories(vararg value: IntrinsicFunction) { this.repositories = value }
