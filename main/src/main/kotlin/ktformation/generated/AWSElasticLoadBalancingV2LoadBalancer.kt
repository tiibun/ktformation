...
class AWSElasticLoadBalancingV2LoadBalancer(logicalId: String) : Resource<AWSElasticLoadBalancingV2LoadBalancer.Properties>(logicalId, "AWS::ElasticLoadBalancingV2::LoadBalancer") {
    ...
    class Properties : ResourceProperties {
        @JvmField var ipAddressType: Any? = null
        fun ipAddressType(value: String?) { this.ipAddressType = value }
        fun ipAddressType(value: IntrinsicFunction) { this.ipAddressType = value }
        @JvmField var loadBalancerAttributes: Any? = null
        fun loadBalancerAttributes(value: List<LoadBalancerAttribute>?) { this.loadBalancerAttributes = value }
        fun loadBalancerAttributes(vararg value: IntrinsicFunction) { this.loadBalancerAttributes = value }
        ...
        @JvmField var subnetMappings: Any? = null
        fun subnetMappings(value: List<SubnetMapping>?) { this.subnetMappings = value }
        fun subnetMappings(vararg value: IntrinsicFunction) { this.subnetMappings = value }
