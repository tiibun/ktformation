...
class AWSAutoScalingAutoScalingGroup(logicalId: String) : Resource<AWSAutoScalingAutoScalingGroup.Properties>(logicalId, "AWS::AutoScaling::AutoScalingGroup") {
    ...
    class Properties : ResourceProperties {
        ...
        fun desiredCapacity(value: String?) { this.desiredCapacity = value }
        fun desiredCapacity(value: IntrinsicFunction) { this.desiredCapacity = value }
        @JvmField var healthCheckGracePeriod: Any? = null
        fun healthCheckGracePeriod(value: Int?) { this.healthCheckGracePeriod = value }
        ...
        fun healthCheckType(value: String?) { this.healthCheckType = value }
        ...
        fun launchConfigurationName(value: String?) { this.launchConfigurationName = value }
        ...
        fun lifecycleHookSpecificationList(value: List<LifecycleHookSpecification>?) { this.lifecycleHookSpecificationList = value }
        ...
        fun loadBalancerNames(value: List<String>?) { this.loadBalancerNames = value }
        ...
        fun metricsCollection(value: List<MetricsCollection>?) { this.metricsCollection = value }
        ...
        fun notificationConfigurations(value: List<NotificationConfiguration>?) { this.notificationConfigurations = value }
        ...
        fun vPCZoneIdentifier(value: List<String>?) { this.vPCZoneIdentifier = value }
